  ...
  return (
    <>
      ...
      <Stack direction="column" mt={5}>
        <Box ml={{ xs: 0, md: '26px' }} display="flex" alignItems="center">
          <Box
        ...
        <MainContainer padding={{ xs: '0 0  100px', md: '30px 30px 100px' }}>
          <PostJobContainer>
            <Box position="relative">
              ...
              <Typography fontWeight={700}>{newJob?.title}</Typography>
            </Box>
            ...
            <Box id="salary" mt={errors.short_description ? '44px' : '20px'}>
              ...
              >
                ...
                <Box width="49%" position="relative">
                  ...
                  {errors.salary?.max && (
                    <FormHelperText>
                      <Image src={InfoIcon} width={14} height={14} />
                  ...
                  options={hightlightColorOptions.map(
                    (option: THightlightColor) =>
                      option.color
                        ...
                        : {
                            text: (
                              <OptionWithTag title={'No color'} price={0} />
                            ),
                            value: '',
                          }
                  )}
